...
INSERT INTO public.role (id, description) VALUES (588885, 'admin');
INSERT INTO public.role (id, description) VALUES (588886, 'tenant');
INSERT INTO public.role (id, description) VALUES (588887, 'landlord');

INSERT INTO public.users (id, last_logged_in_at, active, deleted, email, first_name, lastname, password, role_id) VALUES (55555, '2022-05-11', true, false, 'hassan@miu.edu', 'hassan', 'hassan', '123', 588885);
INSERT INTO public.users (id, last_logged_in_at, active, deleted, email, first_name, lastname, password, role_id) VALUES (55556, '2022-05-11', true, false, 'abdo@miu.edu', 'Abdelrahman', 'Freek', '123', 588886);
INSERT INTO public.users (id, last_logged_in_at, active, deleted, email, first_name, lastname, password, role_id) VALUES (55557, '2022-05-11', true, false, 'john@gmail.com', 'John', 'Mickel', '123', 588887);
...
INSERT INTO public.property (id, deleted, is_occupied, number_of_bathrooms, number_of_bedrooms, property_name, rent_amount, security_deposit_amount, visible, address_id, last_rented_by, owned_by, property_type_id) VALUES (20, true, false, 2, 3, 'appartment with 3 bedrooms', 500, 0, true, 1, null, 3, 1);
INSERT INTO public.property (id, deleted, is_occupied, number_of_bathrooms, number_of_bedrooms, property_name, rent_amount, security_deposit_amount, visible, address_id, last_rented_by, owned_by, property_type_id) VALUES (22, false, false, 2, 3, 'appartment with 3 bedrooms', 500, 0, true, 1, null, 3, 1);
INSERT INTO public.property (id, deleted, is_occupied, number_of_bathrooms, number_of_bedrooms, property_name, rent_amount, security_deposit_amount, visible, address_id, last_rented_by, owned_by, property_type_id) VALUES (22, false, true, 3, 6, 'House with 3 bedrooms', 500, 0, true, 1, 2, 3, 2 );
